...
export default function Hero() {
  return (
    <section className="relative w-full h-screen overflow-hidden flex flex-col justify-between">
      ...
      {/* 3. The Chair (Centerpiece, moved up slightly to make room for text below) */}
      <motion.div 
        id="hero-chair"
      ...
      >
        <img
          ...
          className="h-[45vh] md:h-[60vh] w-auto object-contain drop-shadow-[0_20px_30px_rgba(0,0,0,0.15)]"
        />
      </motion.div>

      {/* 4. Center Typography (Moved to the BOTTOM, below the chair) */}
      <div className="absolute bottom-[10%] md:bottom-[12%] inset-x-0 flex flex-col items-center justify-start z-20 pointer-events-none">
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-light tracking-tight text-[#0F172A] text-center leading-[1.1] drop-shadow-sm">
          Elevate your <br />
      ...
      {/* 5. Middle Content: Video Cards (Airy/Cloud Aesthetic) */}
      <div className="absolute inset-0 z-20 flex-1 w-full h-full pointer-events-none">
        ...
        >
          ...
          <div className="absolute top-4 right-4 md:top-6 md:right-6 w-8 h-8 md:w-10 md:h-10 bg-white/80 backdrop-blur-md rounded-full flex items-center justify-center cursor-pointer hover:bg-white border border-white transition-all shadow-lg">
        ...
        >
          ...
          <div className="relative z-10 w-full h-full rounded-[2rem] overflow-hidden shadow-2xl border border-white/40">
            <video
              ...
              src="/hero-video2.mp4"
            />
            <div className="absolute bottom-4 left-4 w-8 h-8 md:w-12 md:h-12 bg-white/60 backdrop-blur-md rounded-full flex items-center justify-center cursor-pointer hover:bg-white transition-colors border border-white shadow-lg">
      ...
      <div className="absolute bottom-[20%] md:bottom-24 left-4 md:left-10 z-30 flex flex-col items-start gap-4">
        ...
        <button className="bg-white/90 backdrop-blur-md text-[#0F172A] border border-white px-6 py-2 md:px-8 md:py-3 rounded-full text-xs md:text-sm font-semibold hover:bg-white transition-colors shadow-[0_10px_30px_rgba(0,0,0,0.1)]">
          book your chair
        </button>
      </div>
