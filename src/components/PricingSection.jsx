...
export default function PricingSection() {
  ...
  return (
    <section className="relative w-full min-h-screen bg-[#FAFAFA] text-[#0F172A] py-32 overflow-hidden flex flex-col items-center">
      ...
      {/* Background Soft Gradients (Optimized for performance) */}
      <div className="absolute top-0 left-0 w-[60vw] h-[60vw] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-pink-100/40 to-transparent rounded-full pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-[50vw] h-[50vw] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-100/30 to-transparent rounded-full pointer-events-none" />
